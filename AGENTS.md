...
This rule is the top operational priority for future Codex agents working on this app. Do not treat cost as an afterthought. If a feature has both a free and paid architecture, present the free path first and clearly label any paid risk.
